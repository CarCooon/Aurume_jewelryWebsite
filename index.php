    ...
    <main>
        <div class="video-container hidden">
            <video class="video-home" src="resources/img/jewellery_hd.mp4" autoplay loop muted></video>
        </div>
        ...
        <div class="section-image hidden">
            <a href="catalogo.php" onclick="salvaCategoria('anelli')">
                <img src="resources/img/gold_jewels.jpg" alt="Anelli">
        ...
        <div class="section-image hidden">
            <a href="catalogo.php" onclick="salvaCategoria('orologi')">
